//Welp bạn không nên đụng ở bên dưới "/
/* 1175 line commands was made by Catalizcs(roxtigger2003) and SpermLord(spermlord) with love <3, pls dont delete this credits! THANKS very much */
...
var fact = [];
var onoff = true;
var h = moment.tz("Asia/Ho_Chi_Minh").format("HH");
//MODULES//
   ...
   /* //fact của mỗi ngày
    ...
    if (contentMessage.indexOf(`${prefix}anime`) == 0) {
      ...
      if (jsonData.sfw.hasOwnProperty(content))
        ...
        return api.sendMessage(`Dùng ${prefix}anime <nsfw/sfw> để lấy tag`, threadID);
